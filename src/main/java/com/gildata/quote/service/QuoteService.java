...
import com.gildata.quote.model.Quote;
...
public class QuoteService {
	...
	private static class StockQuoteGenerator {
		...
		public StockQuoteGenerator() {
			...
			this.prices.put("1A0001", "2071.88");
			this.prices.put("399001", "18258.13");
			this.prices.put("600570", "16.98");
			this.prices.put("000001", "31.22");
