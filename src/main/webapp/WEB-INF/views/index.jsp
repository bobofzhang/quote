...
<c:url var="bootstrapCss" value="/assets/css/bootstrap.css" />
...
<body>
	...
	<!-- 3rd party -->
	<c:url var="jqueryUrl" value="/assets/js/jquery-2.0.3.min.js" />
	<script src="${jqueryUrl}"><!-- jQuery --></script>
	<c:url var="bootstrapUrl" value="/assets/js/bootstrap.min.js" />
	...
	<c:url var="sockjsUrl" value="/assets/js/sockjs-0.3.4.min.js" />
	<script src="${sockjsUrl}"><!-- sockjs --></script>
	<c:url var="stompUrl" value="/assets/js/stomp.min.js" />
	<script src="${stompUrl}"><!-- stomp --></script>
	<c:url var="highstockUrl" value="/assets/js/highstock.js" />
